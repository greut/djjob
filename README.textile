...
p. DJJob follow the "PSR-0 standard":https://github.com/php-fig/fig-standards/blob/master/accepted/PSR-0.md, so you can add it to your autoloader.
...
* Switch to use proper namespaces.
* Using igbinary for serialization.
